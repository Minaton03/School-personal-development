...
public class UserCreateConfirmAction extends ActionSupport implements SessionAware {
	...
	private int secretQuestion;     //秘密の質問
...
//		性別、秘密の質問バグ対策
		...
		if(secretQuestion < 1 || secretQuestion > 2){
			return result;
		}
		...
		ErrorUserIdList = inputChecker.doCheck("ユーザーID", userId, 1, 8, true, false, false, true, false ,false,false);
		ErrorPasswordList = inputChecker.doCheck("パスワード", password, 1, 16, true, false, false, true, false ,false,false);
		ErrorFamilyNameList = inputChecker.doCheck("姓", familyName, 1, 16, true, true, true, false, false ,false,false);
		ErrorFirstNameList = inputChecker.doCheck("名", firstName, 1, 16, true, true, true, false, false ,false,false);
		ErrorFamilyNameKanaList = inputChecker.doCheck("姓ふりがな", familyNameKana, 1, 16, false, false, true, false, false ,false,false);
		ErrorFirstNameKanaList = inputChecker.doCheck("名ふりがな", firstNameKana, 1, 16, false, false, true, false, false ,false,false);
		ErrorEmailList = inputChecker.doCheck("メールアドレス", email, 14, 32, true, false, false, true, true ,false,false);
		ErrorAnswerList = inputChecker.doCheck("質問の答え", secretAnswer, 1, 10, true, true, true, true, true ,true,true);
